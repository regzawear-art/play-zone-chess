...
export const BOARD_THEMES: BoardTheme[] = [
  {
    ...
    lastMoveBg: 'rgba(205,210,106,0.6)',
    preview: 'linear-gradient(135deg, #eeeed2 50%, #7ba45b 50%)',
  },
  {
    id: 'blue',
    name: 'Ocean Blue',
  ...
  },
  {
    ...
    highlight: '#c4c4c4',
    select: '#a0a0a0',
    legalDot: 'rgba(255,255,255,0.4)',
    legalRing: 'rgba(255,255,255,0.4)',
    checkBg: 'rgba(229,57,53,0.55)',
    lastMoveBg: 'rgba(150,150,150,0.5)',
    preview: 'linear-gradient(135deg, #dedede 50%, #5a5a5a 50%)',
  },
  {
    id: 'ice',
    name: 'Ice Blue',
