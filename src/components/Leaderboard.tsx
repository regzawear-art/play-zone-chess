        ...
        <table className="w-full border-collapse text-left">
          <thead>
            <tr className="text-xs uppercase tracking-wide text-navy-400">
              <th className="px-3 py-3 font-semibold sm:px-6">#</th>
              <th className="px-3 py-3 font-semibold sm:px-6">Player</th>
              <th className="px-3 py-3 text-right font-semibold sm:px-6">Rating</th>
              ...
              <th className="px-3 py-3 text-right font-semibold sm:px-6">Streak</th>
            </tr>
          </thead>
          <tbody>
            {ranked.map((p, i) => {
                ...
                <tr key={p.id} className="group border-t border-white/5 transition-colors hover:bg-navy-600/50">
                  ...
                  <td className="px-3 py-3 sm:px-6">
                    <div className="flex items-center gap-3">
                      <div className="relative h-10 w-10 shrink-0 overflow-hidden rounded-full ring-2 ring-white/10 transition-all group-hover:ring-royal-400/50">
                  ...
                  <td className="px-3 py-3 text-right sm:px-6">
                    ...
                    <div className="mt-1 ml-auto h-1 w-20 overflow-hidden rounded-full bg-navy-600">
