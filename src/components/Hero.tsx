...
const SLIDES: Slide[] = [
    {
        ...
        image:
            'https://images.unsplash.com/photo-1586165368502-1bad197a6461?q=80&w=1920&auto=format&fit=crop',
    ...
    },
    {
        ...
        highlight: 'Worldwide',
        description:
            'Real-time 1v1 Online Matches, Private Rooms & Custom Clubs.',
        cta: [
            {
                label: 'Play Online',
                icon: Globe,
        ...
        image:
            'https://images.unsplash.com/photo-1529699211952-734e80c4d42b?q=80&w=1920&auto=format&fit=crop',
    ...
    },
    {
        ...
        description:
            'Sharpen your tactical skills across Basic, Intermediate, Advanced, and Master stages.',
        cta: [
            {
                label: 'Challenge AI',
                icon: Bot,
        ...
        image:
            'https://images.unsplash.com/photo-1560174038-da43ac74f01b?q=80&w=1920&auto=format&fit=crop',
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="relative">
                        <div className="relative grid">
                            {SLIDES.map((s, i) => (
                                <div
                                    key={i}
                                    className={`col-start-1 row-start-1 transition-all duration-700 ease-smooth ${i === index
                        ...
                        <div className="mt-6 flex items-center gap-3">
                            <button
                                ...
                                className="grid h-9 w-9 shrink-0 place-items-center rounded-full glass text-white shadow-card transition-all hover:bg-navy-600 hover:shadow-glow-sm"
                            >
                                <ChevronLeft size={18} />
                            </button>
                                ...
                                {SLIDES.map((s, i) => (
                                    <button
                                        ...
                                        className={`h-2 rounded-full transition-all duration-500 ${i === index
                                                ? 'w-8 bg-blue-grad shadow-glow-sm'
                                                : 'w-2 bg-navy-500 hover:bg-navy-400'
                                            }`}
                                    />
                                ))}
                            </div>
                    ...
                    <div className="relative">
                        <div className="relative mx-auto aspect-[4/3] w-full max-w-lg overflow-hidden rounded-3xl border border-white/10 shadow-card-lg lg:max-w-none">
                            {SLIDES.map((s, i) => (
                                <div
                                    key={i}
                                    className={`absolute inset-0 transition-opacity duration-700 ease-smooth ${i === index ? 'opacity-100' : 'opacity-0'
                                        }`}
                                >
                                    <img
                                        src={s.image}
                            ...
                            <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between gap-3 rounded-2xl glass-dark p-3 text-white sm:p-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="leading-tight">
                                        <p className="text-xs uppercase tracking-wide text-royal-300">
                                            Live now
                                        </p>

                                        <p className="text-sm font-bold sm:text-base">
                                            12,480 players online
                                        </p>
                                    </div>
                                </div>
                ...
                <div className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
                    {[
                        ...
                        <div
                            key={s.v}
                            className="rounded-2xl glass px-4 py-3 text-center shadow-card sm:py-4"
                        >
                            <p className="font-display text-2xl font-extrabold text-white sm:text-3xl">
                                {s.k}
                            </p>

                            <p className="mt-0.5 text-xs font-medium text-navy-300 sm:text-sm">
                                {s.v}
                            </p>
                        </div>
                    ))}
